...
class StudentPerformanceModel:
    ...
    def train_model_dtree(self, max_depth=None):
        self.model = DecisionTreeClassifier(max_depth=max_depth, random_state=22, ccp_alpha=0.0, criterion='gini', max_features=None, max_leaf_nodes=3, min_samples_leaf=1, min_samples_split=2, min_weight_fraction_leaf=0.0)

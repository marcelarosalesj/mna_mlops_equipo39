...
class TestLoad(unittest.TestCase):
    ...
    def test_df_load(self):
        self.assertIsInstance(load_data(), pandas.core.frame.DataFrame)

    # Verificar que el DataFrame contenga la variable de salida
    def test_df_complete(self):
        self.assertIn("OUTPUT Grade", load_data().columns)
    ...
    def test_save_artifact(self):
        ...
        self.assertTrue(os.path.exists(config["load_data"]["dataset_csv"]))
